...
/**
 * 문자열 null 처리, 치환, 정렬, 분리 등 문자열 유틸리티
 */
public class StringUtil {
	...
	public static String nvlDate(String str) {
		...
		if (str == null || str.equals("null")) {
			...
			retStr = FormatUtil.getExpDateString(str);
		}
	...
	public static String nvlNum(String str) {
		...
		if (str == null || str.equals("null")) {
			...
			retStr = FormatUtil.getExpNumString(str);
		}
	...
	public static int NULLTOZERO(String NullString) {
		...
		try {
			if (NullString == null || NullString.equals("null")) {
				...
				ReturnInt = Integer.parseInt(FormatUtil.getExpDateString(NullString));
			}
		} catch (Exception e) {
		}
