...
<script type="text/javascript" >
	...
	function SetOZParamters_OZViewer(){
		...
		oz.sendToActionScript("connection.reportname", "/sdp/SDPE002001L.ozr");
		
		//사용자변수 지정
		oz.sendToActionScript("odi.odinames", "SDPE002001L");
		oz.sendToActionScript("odi.SDPE002001L.pcount", "2");
		oz.sendToActionScript("odi.SDPE002001L.args1", "ARG_BIZ_AREA_CD=${map.ARG_BIZ_AREA_CD}");
		oz.sendToActionScript("odi.SDPE002001L.args2", "ARG_ITEM_CD=${map.ARG_ITEM_CD}");
